...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url('/homepage-section/view-sections/header-image') }}">Manage Header Image</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
           ...
           <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="{{ url('/homepage-section/add-section/header-image') }}">Add Header Image</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                            ...
                            @foreach($sections as $section)
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    <?php } ?>
                                    <a class="btn btn-primary actionedit" href="{{ url('/homepage-section/add-section/header-image/'.encrypt($section->id)) }}">Edit</a>
                                   </td>
                                </tr>
                            @endforeach
                        </tbody>
