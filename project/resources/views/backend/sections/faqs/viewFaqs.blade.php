...
@section('content')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url('/homepage-section/faqs') }}">Manage Faqs</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header">
              <h3 class="box-title"><a href="{{ url('/homepage-section/add-section/faqs') }}">Add Faq</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                            ...
                            @foreach($sections as $section)
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    <?php } ?>
                                            <a class="btn btn-primary actionedit" href="{{ url('/homepage-section/add-section/faqs/'.encrypt($section->id)) }}">Edit</a>
                                   </td>
                                </tr>
                            @endforeach
                        </tbody>
