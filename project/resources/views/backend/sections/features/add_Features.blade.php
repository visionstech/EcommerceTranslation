...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ url('/homepage-section/view-sections/features') }}">Manage Features</a></li>
                    <li class="active">{{ ($sectionId)?'Edit':'Add'}} Features</li>
                </ol>
            </section>
     <!-- Main content -->
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">{{ ($sectionId)?'Edit':'Add'}} Features</h3>
                </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{ url('/homepage-section/add-section/features') }}" method="post" class="form-horizontal form-label-left" enctype='multipart/form-data'>
