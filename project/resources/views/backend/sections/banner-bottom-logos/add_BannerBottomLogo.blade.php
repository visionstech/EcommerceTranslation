@extends('backend.app')
@section('title')
    {{ ($sectionId)?'Edit':'Add'}} Banner Bottom Logos
@endsection
@section('content')    
    <!-- top tiles -->
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ url('/homepage-section/view-sections/banner-image') }}">Manage Banner Bottom Logos</a></li>
                    <li class="active">{{ ($sectionId)?'Edit':'Add'}} Banner Bottom Logos</li>
                </ol>
            </section>
     <!-- Main content -->
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">{{ ($sectionId)?'Edit':'Add'}} Banner Bottom Logo</h3>
                </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{ url('/homepage-section/add-section/banner-bottom-logos') }}" method="post" class="form-horizontal form-label-left" enctype='multipart/form-data'>
