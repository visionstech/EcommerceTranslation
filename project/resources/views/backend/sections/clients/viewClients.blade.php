...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url('/homepage-section/view-sections/clients') }}">Manage Clients</a></li>
      </ol>
    </section>
                                ...
                                <tr>
                                   ...
                                   <td>
                                    <?php if($section->status != 'Deactive'){ ?>
                                            <a class="btn btn-primary actionAnchor" data-target="{{ '.bs-example-modal-dm_'.$section->id }}" data-toggle="modal" href="javascript:void(0);" data-did="{{ encrypt($section->id) }}" data-status="Deactive" data-statusDiv="Deactive">Deactive</a>
                                    <?php }else{ ?>
