<aside class="dashboard-menu">
      <ul>
        ...
        <li class="has-child {{ ((strpos($_SERVER['REQUEST_URI'],'customer/assets/gloosaries') != false) || (strpos($_SERVER['REQUEST_URI'],'customer/assets/styles') != false) || (strpos($_SERVER['REQUEST_URI'],'customer/assets/briefs') != false) || (strpos($_SERVER['REQUEST_URI'],'customer/single-asset') != false))?'active':'' }}">
          <a href="javascript::void(0)" title="Translation Assets"><i class="fa fa-files-o" aria-hidden="true"></i> Translation Assets</a>
          <ul class="sub-child">
            <li class="{{ ((strpos($_SERVER['REQUEST_URI'],'customer/assets/gloosaries') != false) || (strpos($_SERVER['REQUEST_URI'],'customer/single-asset/gloosaries') != false))?'active':'' }}"><a href="{{ url('customer/assets/gloosaries') }}" title="Glossaries">Glossaries</a></li>
