      ...
      <div class="signin-wrap">
        ...
        <form action="{{ url('/auth/login') }}" method="post">
          ...
          <div class="sign-btn-wrap eqho-clear-fix forgot-pwd">
            ...
            <a href="{{ url('/auth/reset-password') }}" title="Forgot your password">Forgot your <span>Password?</span></a>
          </div>
          <p>Or Sign in using social network</p>
          <div class="social-icon">
            <a href="{{ url('/dashboard/social-redirect') }}" class="fb" title="Sign in with facebook"><i class="fa fa-facebook" aria-hidden="true"></i> <span>Sign in with facebook</span></a>
