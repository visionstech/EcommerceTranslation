<?php $__env->startSection('title'); ?>
    <?php echo e(($sectionId)?'Edit':'Add'); ?> Banner Image
...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo e(url('/homepage-section/view-sections/banner-image')); ?>">Manage Banner Image</a></li>
                    <li class="active"><?php echo e(($sectionId)?'Edit':'Add'); ?> Banner Image</li>
                </ol>
            </section>
     <!-- Main content -->
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo e(($sectionId)?'Edit':'Add'); ?> Banner Image</h3>
                </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo e(url('/homepage-section/add-section/banner-image')); ?>" method="post" class="form-horizontal form-label-left" enctype='multipart/form-data'>
