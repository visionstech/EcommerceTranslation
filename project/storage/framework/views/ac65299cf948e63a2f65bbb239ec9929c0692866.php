<?php $__env->startSection('title'); ?>
    <?php echo e(($sectionId)?'Edit':'Add'); ?> Header Image
...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo e(url('/homepage-section/view-sections/header-image')); ?>">Manage Header Image</a></li>
                    <li class="active"><?php echo e(($sectionId)?'Edit':'Add'); ?> Header Image</li>
                </ol>
            </section>
     <!-- Main content -->
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo e(($sectionId)?'Edit':'Add'); ?> Header Image</h3>
                </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo e(url('/homepage-section/add-section/header-image')); ?>" method="post" class="form-horizontal form-label-left" enctype='multipart/form-data'>
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                <input type="hidden" name="sectionType" value="header-image">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                   <label for="image">Header Image<span class="required">*</span></label>
