                                ...
                                <tr>
                                   ...
                                   <td>
                                    <?php if($languagePackage->status != 'Deactive'){ ?>
                                            <a class="btn btn-primary actionAnchor" data-target=".bs-example-modal-dm" data-toggle="modal" href="javascript:void(0);" data-did="<?php echo e(encrypt($languagePackage->id)); ?>" data-status="Deactive" data-statusDiv="Deactive">Deactive</a>
                                    <?php }else{ ?>
