...
<?php $__env->startSection('content'); ?>
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo e(url('/homepage-section/faqs')); ?>">Manage Faqs</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header">
              <h3 class="box-title"><a href="<?php echo e(url('/homepage-section/add-section/faqs')); ?>">Add Faq</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                            ...
                            <?php foreach($sections as $section): ?>
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    <?php } ?>
                                            <a class="btn btn-primary actionedit" href="<?php echo e(url('/homepage-section/add-section/faqs/'.encrypt($section->id))); ?>">Edit</a>
                                   </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<div class="modal fade bs-example-modal-dm" aria-hidden="true" role="dialog" tabindex="-1" style="display: none;">   <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="type" class="type" value='faqs'/>
