<aside class="dashboard-menu">
      <ul>
        ...
        <li class="has-child <?php echo e(((strpos($_SERVER['REQUEST_URI'],'customer/assets/glossaries') != false) || (strpos($_SERVER['REQUEST_URI'],'customer/assets/styles') != false) || (strpos($_SERVER['REQUEST_URI'],'customer/assets/briefs') != false) || (strpos($_SERVER['REQUEST_URI'],'customer/single-asset') != false))?'active':''); ?>">
          <a href="javascript::void(0)" title="Translation Assets"><i class="fa fa-files-o" aria-hidden="true"></i> Translation Assets</a>
          <ul class="sub-child">
            <li class="<?php echo e(((strpos($_SERVER['REQUEST_URI'],'customer/assets/glossaries') != false) || (strpos($_SERVER['REQUEST_URI'],'customer/single-asset/gloosaries') != false))?'active':''); ?>"><a href="<?php echo e(url('customer/assets/glossaries')); ?>" title="Glossaries">Glossaries</a></li>
