...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo e(url('/homepage-section/view-sections/header-image')); ?>">Manage Header Image</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
           ...
           <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="<?php echo e(url('/homepage-section/add-section/header-image')); ?>">Add Header Image</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                            ...
                            <?php foreach($sections as $section): ?>
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    <?php } ?>
                                    <a class="btn btn-primary actionedit" href="<?php echo e(url('/homepage-section/add-section/header-image/'.encrypt($section->id))); ?>">Edit</a>
                                   </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<div class="modal fade bs-example-modal-dm" aria-hidden="true" role="dialog" tabindex="-1" style="display: none;">   <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="type" class="type" value='header-image'/>
