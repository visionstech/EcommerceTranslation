...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="<?php echo e(url('/dashboard/social-redirect')); ?>" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using
        Facebook</a>
    ...
    <a href="<?php echo e(url('/auth/reset-password')); ?>">I forgot my password</a><br>
