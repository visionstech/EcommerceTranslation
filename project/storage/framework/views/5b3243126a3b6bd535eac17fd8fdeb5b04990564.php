<?php $__env->startSection('title'); ?>
    <?php echo e(($sectionId)?'Edit':'Add'); ?> Clients
...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo e(url('/homepage-section/view-sections/clients')); ?>">Manage Clients</a></li>
                    <li class="active"><?php echo e(($sectionId)?'Edit':'Add'); ?> Clients</li>
                </ol>
            </section>
     <!-- Main content -->
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo e(($sectionId)?'Edit':'Add'); ?> Clients</h3>
                </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo e(url('/homepage-section/add-section/clients')); ?>" method="post" class="form-horizontal form-label-left" enctype='multipart/form-data'>
