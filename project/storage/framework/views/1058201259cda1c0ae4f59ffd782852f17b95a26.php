      ...
      <ul class="sidebar-menu">
        ...
        <?php if(Auth::user()){ 
          ...
          ?>
                ...
                <li class="<?php echo e((strpos($_SERVER['REQUEST_URI'],'language-management') != false)?'active':''); ?>">
                  <a href="<?php echo e(url('/language-management')); ?>">
                    <i class="fa fa-language" aria-hidden="true"></i> <span>Manage Languages</span>
                  </a>
                </li>
                <li class="<?php echo e((strpos($_SERVER['REQUEST_URI'],'language-price') != false)?'active':''); ?>">
                  <a href="<?php echo e(url('/language-price')); ?>">
                    <i class="fa fa-money" aria-hidden="true"></i> <span>Manage Language Price</span>
                  </a>
                </li>
                <li class="<?php echo e((strpos($_SERVER['REQUEST_URI'],'language-package') != false)?'active':''); ?>">
                  <a href="<?php echo e(url('/language-package')); ?>">
                    <i class="fa fa-product-hunt" aria-hidden="true"></i> <span>Manage Language Package</span>
                  </a>
                </li>
                <li class="<?php echo e(((strpos($_SERVER['REQUEST_URI'],'management/all-projects') != false) || (strpos($_SERVER['REQUEST_URI'],'management/view-order/view') != false) || (strpos($_SERVER['REQUEST_URI'],'management/feedbacks') != false))?'active':''); ?> treeview">
                  <a href="#">
                  ...
                  <ul class="treeview-menu">
                    <li class="<?php echo e(((strpos($_SERVER['REQUEST_URI'],'/management/all-projects') != false) || (strpos($_SERVER['REQUEST_URI'],'management/view-order/view') != false))?'active':''); ?>"><a href="<?php echo e(url('/management/all-projects')); ?>"><i class="fa fa-circle-o"></i> View Orders</a></li>
                    <li class="<?php echo e((strpos($_SERVER['REQUEST_URI'],'/management/feedbacks') != false)?'active':''); ?>"><a href="<?php echo e(url('/management/feedbacks')); ?>"><i class="fa fa-circle-o"></i> View Request Changes</a></li>                    
                  </ul>
                </li>          
                <li class="<?php echo e((strpos($_SERVER['REQUEST_URI'],'homepage-section') != false)?'active':''); ?> treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li class="<?php echo e((strpos($_SERVER['REQUEST_URI'],'clients') != false)?'active':''); ?>"><a href="<?php echo e(url('/homepage-section/view-sections/clients')); ?>"><i class="fa fa-circle-o"></i> Manage Clients</a></li>
                     <li class="<?php echo e((strpos($_SERVER['REQUEST_URI'],'header-image') != false)?'active':''); ?>"><a href="<?php echo e(url('/homepage-section/view-sections/header-image')); ?>"><i class="fa fa-circle-o"></i> Manage Header Image</a></li>
