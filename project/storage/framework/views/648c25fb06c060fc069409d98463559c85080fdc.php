               ...
               ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript::void(0)" class="delete_asset" data-url="<?php echo e(url('/customer/delete-single-asset/'.$type.'/'.encrypt($asset['id']))); ?>" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i> Delete </a>
                  </td>
                </tr>
                <?php $s++; ?>
              <?php endforeach; ?>
